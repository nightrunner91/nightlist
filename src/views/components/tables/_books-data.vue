  ...
  div(class='data' v-if='data.length > 0')
    ...
    div(
      ...
      div(
        ...
        //- TITLE
        div(
          class='slot__cell slot__cell--functional grid__col grid__col--lg-12 grid__col--md-12 grid__col--sm-11'
        ...
        //- AUTHOR
        div(
          class='slot__cell slot__cell--functional grid__col grid__col--lg-11 grid__col--md-11 grid__col--sm-10'
      ...
      div(
        ...
        transition-group
          ...
          div(
            ...
            //- TITLE
            div(class='slot__cell grid__col grid__col--lg-12 grid__col--md-12 grid__col--sm-11')
              span {{slot.title}}
              a(
                :ref='"redirect"'
                rel='nofollow'
            ...
            //- AUTHOR
            div(class='slot__cell grid__col grid__col--lg-11 grid__col--md-11 grid__col--sm-10')
              span {{slot.author}}
...
export default {
  ...
  data() {
    return {
      criteria: 'title',
      tableVisibilityName: 'books_' + this.id + '_visible',
      direction: true,
      data: [],
      tableVisible: true,
      noTransition: true,
  ...
  methods: {
    tableName(id) {
      return this.books.statuses.filter(i => i.id == id)[0].name
    },
    ...
    stashData() {
      this.data = this.booksCollection.filter(i => i.status == this.id)
    },
