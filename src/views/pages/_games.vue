<template lang='pug'>
  section(class='section')
    ...
    div(class='table')
      ...
      div(class='table__body')
        div(class='table__item')
          div(class='table__cell table__cell--index') 1
          div(class='table__cell table__cell--title') Assassin's Creed
        ...
        div(class='table__item')
          div(class='table__cell table__cell--index') 2
          div(class='table__cell table__cell--title') Assassin's Creed 2
          div(class='table__cell table__cell--rating') 5
          div(class='table__cell table__cell--hours') 24
          div(class='table__cell table__cell--action') edit

        div(class='table__item')
          div(class='table__cell table__cell--index') 3
          div(class='table__cell table__cell--title') Assassin's Creed 3
          div(class='table__cell table__cell--rating') 5
          div(class='table__cell table__cell--hours') 24
          div(class='table__cell table__cell--action') edit
    ...
    div(class='title')
      h3(class='title__name') On-hold
      span(class='title__badge badge badge--medium') 18
