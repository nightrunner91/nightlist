...
* Написание Back-end составляющей для действий добавления/редактирования/удаления тайтлов и синхронизации localStorage и БД.
...
* Покупка подходящего доменного имени (вероятный кандидат ```collct.me```).
