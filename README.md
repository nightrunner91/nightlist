...
На этом этапе возможен (скорее, необходим) переход на более комплексный и гибкий Back-end, нежели Google Cloud / Dropbox
...
* Внедрение монетизации (вероятнее всего, с системой премиум-функций вроде установки собственных фоновых изображений)
